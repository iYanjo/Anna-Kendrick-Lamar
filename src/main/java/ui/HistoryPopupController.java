...
public class HistoryPopupController {

    public HistoryPopupController(){
        init();
    }
...
//        setupEditableTableView();
    ...
    private ChangeListener<String> setupSearchField(final JFXTreeTableView<HistoryPopupController.Person> tableView) {
